...
public class CardTestBuilder extends BaseTestBuilder {
	...
	public static Card buildModel(Integer id) {
		Card model = buildModel();
	...
	public static Card buildModel(final String name, final String imgUrl, final CardType cardType,
			final CardStatus cardStatus) {
		return Card.CardBuilder.Card(name, cardType, cardStatus, imgUrl).build();
	}
	//
	...
	// }
	//
	// public static Resource buildResource(final String name, final String token,
	// final String email,
	...
	// return buildResource(CLIENT_NAME, CLIENT_TOKEN, CLIENT_EMAIL,
	// buildClientHost(CLIENT_HOSTS),
	...
	public static CardResource buildResource(final Integer cardTypeId, final String name, final String imgUrl,
			final String status) {
